...
export default function GymsNowClientPage() {
  return (
    <IndustryPageTemplate
      ...
      industryNameSingular="Fitness Business"
      heroSubtitle={
        <>
          AI that <span className="text-[#00BFFF]">Boosts Memberships</span>
          <br />
      ...
      finalCtaDescription="Join the fittest gyms in the industry using AI to pack their facilities and build lasting relationships."
    />
  )
}
