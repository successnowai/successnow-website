...
export function GymsNowClientPage() {
      ...
      <section className="relative text-center py-16 px-6 md:px-10 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto space-y-8">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight tracking-tight">
            ...
            <span className="block text-white animate-fadeTextUp animation-delay-600">To Grow Your Community</span>
          </h1>
          ...
          <div className="bg-red-600/20 border border-red-500 rounded-lg p-4 max-w-2xl mx-auto animate-fadeTextUp animation-delay-900">
            <p className="text-red-300 font-bold text-lg">⚠️ Empty classes and member churn are costing you!</p>
          </div>

          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto animate-fadeTextUp animation-delay-1200">
            Stop losing members to poor follow-up and scheduling headaches. Our{" "}
            <strong className="text-white">AI fills classes, confirms bookings, and engages every member</strong> to
            boost retention.
          </p>
      ...
      <div className="mx-auto max-w-4xl px-5 py-15">
        <div className="mb-12">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              "Losing trial members because no one follows up",
              "Staff too busy to handle new membership inquiries",
              "High cancellation rates for classes and memberships",
              "Struggling to keep members engaged and motivated",
              "Manual class booking and reminders are time-consuming",
              "Inconsistent communication with your member base",
            ].map((pain, index) => (
              <Card
                key={index}
        ...
        <div className="mb-12">
          ...
          <div className="grid gap-4 sm:grid-cols-1">
            {[
              "💪 24/7 AI assistant to capture and convert every lead",
              "📅 Automated class booking, waitlist management, and reminders",
              "🎯 Personalized member engagement and retention campaigns",
              "💬 Answers membership questions instantly, any time of day",
              "📈 Integrates with your existing gym management software",
              "🏆 Automatically encourages members to leave 5-star reviews",
            ].map((solution, index) => (
              <Card
                key={index}
                className="bg-black/40 backdrop-blur-sm border-[#00BFFF]/20 hover:border-[#00BFFF]/40 transition-all duration-300"
