            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-2xl overflow-hidden">
              <div className="p-6 sm:p-8 text-center">
                <div className="flex flex-col items-center space-y-4 sm:space-y-6">
                  ...
                  >
                    <div className="w-24 sm:w-32 h-24 sm:h-32 rounded-full bg-gradient-to-br from-rose-400/30 to-purple-600/50 backdrop-blur-sm border border-rose-400/40 flex items-center justify-center relative overflow-hidden shadow-2xl">
