...
export default function PlumbersNowClientPage() {
  const props = {
    ...
    heroSubtitle: (
      <>
        AI that <span className="text-[#00BFFF]">Keeps Your Phones Ringing</span> To Unclog Your Growth
      </>
    ),
    ...
    featureCards: [
      ...
      },
      {
        ...
        description: "Connects with your Field Service Management software (like ServiceTitan) for seamless dispatch.",
      },
      {
        icon: GraduationCap,
    ...
    finalCtaDescription:
      "Join the top plumbing companies using AI to streamline their operations and dominate their service area.",
  }
