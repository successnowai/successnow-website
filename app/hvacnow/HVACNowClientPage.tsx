...
export default function HVACNowClientPage() {
  return (
    <IndustryPageTemplate
      ...
      heroSubtitle={
        <>
          AI that <span className="text-[#00BFFF]">Books Service Calls 24/7</span>
          <br />
          To Keep You Cool
        </>
      }
      ...
      heroDescription={
        <>
          ...
          <span className="text-[#00BFFF]">AI dispatcher books jobs, provides instant quotes, and follows up</span> to
          keep your schedule packed.
        </>
      }
      ...
      featureCards={[
        ...
        },
        {
          ...
          description:
            "AI-powered campaigns to automatically sell profitable service agreements to existing customers.",
        },
        {
          icon: Globe,
