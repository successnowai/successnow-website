      ...
      <section className="relative text-center py-16 px-6 md:px-10 bg-black/20 backdrop-blur-sm">
        ...
        <div className="relative z-10 max-w-6xl mx-auto space-y-8">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto animate-fadeTextUp animation-delay-900">
            Run a tighter, faster, more accountable law practice without chasing clients or burning yourself out. Our{" "}
        ...
        <div className="mb-12">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              "Clients shopping elsewhere while you're handling other cases",
              "No-shows and missed consultations killing your conversion rates",
              "Manual processes eating up time that should be spent on cases",
        ...
        <div className="mb-12">
          ...
          <div className="grid gap-4 sm:grid-cols-1">
            {[
              ...
              "💬 Handles legal questions & FAQs instantly - no waiting for attorneys",
