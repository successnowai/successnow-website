...
interface LawyersNowClientPageProps {
  templates: Template[]
}

export function LawyersNowClientPage({ templates }: LawyersNowClientPageProps) {
      ...
      <section className="relative text-center py-16 px-6 md:px-10 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto space-y-8">
          ...
          <div className="bg-red-600/20 border border-red-500 rounded-lg p-4 max-w-2xl mx-auto animate-fadeTextUp animation-delay-900">
            <p className="text-red-300 font-bold text-lg">⚠️ Missed calls are missed cases. Stop losing clients.</p>
          </div>

          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto animate-fadeTextUp animation-delay-1200">
            Stop losing clients to unresponsive intake and forgotten follow-ups. Our{" "}
            <strong className="text-white">AI qualifies leads, books consultations, and nurtures every prospect</strong>{" "}
            until they retain your firm.
          </p>
          ...
          <div className="mt-8 animate-fadeTextUp animation-delay-1800">
            <div className="bg-gradient-to-r from-[#00274D]/80 to-[#1a2332]/80 backdrop-blur-sm p-6 rounded-xl border border-[#00BFFF]/30">
              <h3 className="text-xl sm:text-2xl font-bold mb-3 text-[#00BFFF]">
                ⚖️ Custom Built for YOUR Law Practice
              </h3>
              <div className="space-y-3 text-gray-300 text-sm sm:text-base leading-relaxed">
                ...
                <p>
                  <strong className="text-white">Custom AI Agent:</strong> Trained on your practice areas, legal
                  processes, and client intake procedures
                </p>
                <p>
                  <strong className="text-white">Never Miss Anything:</strong> AI agents that never miss a potential
      ...
      <div className="mx-auto max-w-4xl px-5 py-15">
        <div className="mb-12">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              "Losing potential clients to firms that answer the phone 24/7",
              "Paralegals and staff are overwhelmed with intake calls",
              "High no-show rates for initial consultations",
              "Inconsistent lead follow-up when you're in court or busy",
              "Struggling to get positive reviews from satisfied clients",
              "Spending too much time qualifying non-viable leads",
            ].map((pain, index) => (
              <Card
                key={index}
        ...
        <div className="mb-12">
          ...
          <div className="grid gap-4 sm:grid-cols-1">
            {[
              "⚖️ 24/7 AI legal intake specialist that never misses a call",
              "📅 Automated consultation booking and appointment confirmations",
              "🎯 Nurture sequences to keep your firm top-of-mind",
              "💬 Answers common legal questions to pre-qualify clients",
              "📈 Integrates with your case management software",
              "🏆 Automatically requests reviews from happy clients to build your reputation",
            ].map((solution, index) => (
              <Card
                key={index}
                className="bg-black/40 backdrop-blur-sm border-[#00BFFF]/20 hover:border-[#00BFFF]/40 transition-all duration-300"
        ...
        <div className="text-center bg-[#00274D]/80 backdrop-blur-sm p-12 rounded-2xl border border-[#00BFFF]/30">
          <h3 className="text-3xl font-bold mb-6 text-[#00BFFF]">Ready to Grow Your Law Practice with AI?</h3>
