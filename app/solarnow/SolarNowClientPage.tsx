...
export default function SolarNowClientPage() {
  const props = {
    ...
    heroSubtitle: (
      <>
        AI that <span className="text-[#00BFFF]">Books More Consultations</span> To Power Your Growth
      </>
    ),
    ...
    heroDescription: (
      <>
        ...
        <span className="text-[#00BFFF] font-semibold">
          AI qualifies homeowners, books consultations, and nurtures prospects
        </span>{" "}
    ...
    finalCtaDescription:
      "Join the brightest solar companies using AI to generate more qualified appointments and install more systems.",
  }
