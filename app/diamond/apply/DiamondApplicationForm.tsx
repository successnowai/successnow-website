        ...
        <Card className="bg-gradient-to-br from-black via-gray-900 to-black border-gray-300/30 shadow-2xl">
          <CardHeader>
            <CardTitle className="text-2xl text-white flex items-center">
              ...
              Diamond Class Application Form
            </CardTitle>
            <p className="text-gray-300">
              Please provide detailed information about yourself and your business. This helps us ensure Diamond Class
              is the right fit for your success journey.
            </p>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <Label htmlFor="whyDiamond" className="text-gray-300">
                    Why do you want to join Diamond Class? What specific results are you looking for? *
                  </Label>
                  <Textarea
                    id="whyDiamond"
                    name="whyDiamond"
              ...
              <div className="bg-[#00BFFF]/10 rounded-lg p-6 border border-[#00BFFF]/20">
                ...
                <p className="text-gray-300 text-sm mb-4">
                  By submitting this application, I understand that Diamond Class is an exclusive program for serious
