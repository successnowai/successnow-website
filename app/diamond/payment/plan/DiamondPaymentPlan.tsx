    ...
    <div className="min-h-screen bg-black text-white py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-12">
          ...
          <div className="bg-gradient-to-br from-red-500/10 to-orange-400/10 rounded-lg p-4 max-w-2xl mx-auto mt-4">
            <div className="flex items-center justify-center mb-2">
              <span className="text-orange-400 font-bold">💰 SAVE BIG WITH PAY IN FULL!</span>
            </div>
            <p className="text-gray-300 text-sm text-center">
              Pay in full and save $8,994! Limited time offer - only 5 spots available.
            </p>
          </div>
        </div>
