  ...
  return (
    <div className="bg-gray-900 text-white">
      <div className="text-center py-20 bg-gray-800">
        <h1 className="text-5xl font-bold mb-4">AI for Dentists</h1>
        <p className="text-xl text-gray-400">Fill your schedule by letting your AI assistant book appointments.</p>
      </div>
