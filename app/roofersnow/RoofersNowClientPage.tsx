...
export function RoofersNowClientPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0B1426] via-[#1a2332] to-[#0B1426] text-white">
      <section className="relative text-center py-16 px-6 md:px-10 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto space-y-8">
          ...
          <div className="bg-red-600/20 border border-red-500 rounded-lg p-4 max-w-2xl mx-auto animate-fadeTextUp animation-delay-900">
            <p className="text-red-300 font-bold text-lg">⚠️ A missed call after a storm is a roof you didn't replace.</p>
          </div>

          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto animate-fadeTextUp animation-delay-1200">
            Stop losing high-value roofing jobs to competitors who answer the phone first. Our{" "}
            <strong className="text-white">
              AI qualifies leads, books inspections, and follows up relentlessly
            </strong>
            , so you can focus on installations.
          </p>
          ...
          <div className="mt-8 animate-fadeTextUp animation-delay-1800">
            <div className="bg-gradient-to-r from-[#00274D]/80 to-[#1a2332]/80 backdrop-blur-sm p-6 rounded-xl border border-[#00BFFF]/30">
              ...
              <div className="space-y-3 text-gray-300 text-sm sm:text-base leading-relaxed">
                <p>
                  <strong className="text-white">Custom Website:</strong> Branded to your roofing expertise and local
                  reputation
                </p>
                <p>
                  <strong className="text-white">Custom AI Smart Funnels:</strong> Tailored to your inspection process,
                  materials, and service areas
                </p>
                <p>
                  <strong className="text-white">Custom AI Agent:</strong> Trained on your roofing systems, insurance
                  claim process, and project timelines
                </p>
                <p>
                  <strong className="text-white">Never Miss Anything:</strong> AI agents that never miss a storm damage
                  lead, never miss inspection follow-ups, makes notes and transcripts of every homeowner interaction
                </p>
                <p className="text-[#00BFFF] font-semibold">
                  It's like having the best sales manager using all the best AI tools. Save countless money on staff
                  that make excuses, call in sick, aren't motivated, or don't follow up on leads.
                </p>
      ...
      <div className="mx-auto max-w-4xl px-5 py-15">
        <div className="mb-12">
          <h3 className="text-3xl font-bold text-center mb-8 text-[#00BFFF]">Roofing Business Challenges We Solve</h3>
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              "Missing calls from homeowners with storm damage",
              "Losing jobs to the first roofer who gives a quote",
              "Forgetting to follow up with homeowners after an inspection",
              "Struggling to get reviews that build trust with new customers",
              "Sales team is overwhelmed with unqualified leads",
              "Manually scheduling and confirming every inspection",
            ].map((pain, index) => (
              <Card
                key={index}
        ...
        <div className="mb-12">
          ...
          <div className="grid gap-4 sm:grid-cols-1">
            {[
              "🏠 24/7 AI assistant to capture every lead, especially after storms",
              "📅 Automated inspection booking and route planning",
              "🎯 Relentless, automated follow-up on every quote you send",
              "💬 Answers common questions about materials, warranties, and insurance",
              "📈 Integrates with your CRM and project management tools",
              "🏆 Automatically requests reviews from every happy customer",
            ].map((solution, index) => (
              <Card
                key={index}
                className="bg-black/40 backdrop-blur-sm border-[#00BFFF]/20 hover:border-[#00BFFF]/40 transition-all duration-300"
        ...
        <div className="text-center bg-[#00274D]/80 backdrop-blur-sm p-12 rounded-2xl border border-[#00BFFF]/30">
          <h3 className="text-3xl font-bold mb-6 text-[#00BFFF]">Ready to Win More Roofing Jobs?</h3>
          <p className="text-gray-300 mb-8 text-lg">Join top roofers using AI to grow their business.</p>
