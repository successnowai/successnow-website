...
export default function RoofersNowClientPage() {
  const props = {
    ...
    heroSubtitle: (
      <>
        AI that <span className="text-[#00BFFF]">Closes More Jobs</span> To Put You On Top
      </>
    ),
    ...
    finalCtaDescription:
      "Join elite roofing companies using AI to streamline their sales process and dominate their market.",
  }
