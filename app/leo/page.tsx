        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="text-center lg:text-left space-y-8">
              <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rounded-full border border-blue-500/30">
                <Sparkles className="w-4 h-4 mr-2 text-yellow-400" />
                <span className="text-sm font-semibold text-blue-300">EXCLUSIVE LEO PARTNERSHIP</span>
              </div>
              ...
              <div className="p-8 text-center">
                <div className="flex flex-col items-center space-y-6">
                  ...
                  >
                    ...
                    <div className="w-32 h-32 rounded-full bg-gradient-to-br from-blue-400/30 to-purple-600/50 backdrop-blur-sm border border-blue-400/40 flex items-center justify-center relative overflow-hidden shadow-2xl">
                      {/* Inner glow layers */}
                      ...
                      <div
                        className="absolute inset-3 rounded-full bg-gradient-to-br from-blue-400/50 to-purple-400/70 blur-xs animate-pulse"
                        style={{ animationDelay: "0.5s" }}
                      ></div>
                      <div
                        className="absolute inset-6 rounded-full bg-gradient-to-br from-blue-300/60 to-purple-300/80 blur-sm animate-pulse"
                    ...
                    {/* Outer glow effects */}
                    <div className="absolute inset-0 w-32 h-32 rounded-full bg-blue-400/30 blur-xl animate-pulse"></div>
                    <div
                      className="absolute inset-0 w-32 h-32 rounded-full bg-purple-400/20 blur-2xl animate-pulse"
                      style={{ animationDelay: "1.5s" }}
                    ></div>
                    <div
                      className="absolute -inset-4 w-40 h-40 rounded-full bg-blue-300/10 blur-3xl animate-pulse"
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-2xl">
              <div className="p-8">
                <h3 className="text-2xl font-bold text-blue-400 mb-6">🎯 The Leo Advantage</h3>
                <div className="space-y-6">
                  <div>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-2xl">
              <div className="p-8">
                ...
                <p className="text-blue-400 font-semibold mt-4 text-lg">- Michael R., Business Owner</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                { number: "1000+", label: "Success Stories", color: "text-blue-400" },
            ...
            <div className="bg-white/10 backdrop-blur-md border border-orange-400/30 rounded-2xl shadow-2xl">
              <div className="p-8">
                <h3 className="text-2xl font-bold text-orange-400 mb-4 flex items-center">
                  ...
                  Exclusive Leo Network Access
                </h3>
                <p className="text-white/90 mb-6 text-lg leading-relaxed">
                  Leo has secured special access and pricing for his trusted network. This is a limited-time opportunity
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-2xl">
            <div className="p-10">
              <h3 className="text-4xl font-bold text-blue-400 mb-6 text-center">
                ✨ Join Leo's Exclusive Network Today
              </h3>
