          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="mb-8 p-6 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-lg backdrop-blur-sm max-w-4xl mx-auto">
              ...
              <p className="text-white font-bold text-lg leading-tight">
                SuccessNOW.ai was founded by sales innovator John Potvin, who transformed decades of door-to-door and
                enterprise sales expertise into AI Super Agents that work 24/7 to qualify leads, book appointments, and
                close deals for businesses worldwide.
              </p>
            </div>
            ...
            <div className="mb-8 max-w-4xl mx-auto">
              <div className="grid md:grid-cols-3 gap-4 text-left">
                <div className="bg-gray-900/50 p-4 rounded-lg border border-gray-700">
                  <h3 className="text-cyan-400 font-semibold mb-2">• Founded by Sales Expert</h3>
                  <p className="text-gray-300 text-sm">John Potvin's decades of proven sales experience</p>
                </div>
                <div className="bg-gray-900/50 p-4 rounded-lg border border-gray-700">
                  <h3 className="text-cyan-400 font-semibold mb-2">• AI Super Agents Technology</h3>
                  <p className="text-gray-300 text-sm">Revolutionary AI that learns and adapts to your business</p>
                </div>
                <div className="bg-gray-900/50 p-4 rounded-lg border border-gray-700">
                  <h3 className="text-cyan-400 font-semibold mb-2">• Global Business Impact</h3>
                  <p className="text-gray-300 text-sm">Empowering businesses across U.S. and Canada</p>
                </div>
              </div>
            </div>
