...
import { Phone, Building2, Car, Dumbbell, Zap, Users, MessageSquare, BarChart3, Target, User } from "lucide-react"
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <section className="relative z-10 py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="bg-gray-900/40 backdrop-blur-xl border-gray-700/50 hover:border-pink-500/50 transition-all duration-300">
            ...
            <Card className="bg-gray-900/40 backdrop-blur-xl border-gray-700/50 hover:border-purple-500/50 transition-all duration-300">
              <CardContent className="p-8">
                <div className="flex items-start gap-4 mb-6">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center">
              <Card className="bg-gray-900/40 backdrop-blur-xl border-gray-700/50 p-8 text-center max-w-sm">
      ...
      <section className="relative z-10 py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Automotive Era */}
            <Card className="bg-gray-900/40 backdrop-blur-xl border-gray-700/50 hover:border-blue-500/50 transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-4">
            ...
            {/* Entrepreneurship */}
            <Card className="bg-gray-900/40 backdrop-blur-xl border-gray-700/50 hover:border-pink-500/50 transition-all duration-300 md:col-span-2 lg:col-span-1">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-4">
            ...
            {/* AI Revolution */}
            <Card className="bg-gray-900/40 backdrop-blur-xl border-gray-700/50 hover:border-purple-500/50 transition-all duration-300 md:col-span-2 lg:col-span-2">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-4">
      ...
      <section className="relative z-10 py-20 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <Card className="bg-gray-900/40 backdrop-blur-xl border-gray-700/50 p-8 md:p-12">
      ...
      <section className="relative z-10 py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <Card className="bg-gray-900/40 backdrop-blur-xl border-gray-700/50 p-8 md:p-12 mb-12">
      ...
      <section className="relative z-10 py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="bg-gray-900/40 backdrop-blur-xl border-gray-700/50 hover:border-cyan-500/50 transition-all duration-300">
              <CardContent className="p-8">
                <div className="flex items-center gap-4 mb-6">
