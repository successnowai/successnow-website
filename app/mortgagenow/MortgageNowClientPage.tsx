        ...
        <div className="mb-12">
          ...
          <div className="grid gap-4 sm:grid-cols-1">
            {[
              ...
              "📅 Books more consultations and ensures borrowers actually show up",
              "🎯 Reactivates cold leads automatically until they're ready to apply",
              "💬 Handles loan questions & concerns instantly - no waiting for officers",
              "📈 Integrates seamlessly with your existing loan management system",
              "🏆 Creates engaging, trustworthy conversations that build confidence",
            ].map((solution, index) => (
              <Card
                key={index}
                className="bg-black/40 backdrop-blur-sm border-[#00BFFF]/20 hover:border-[#00BFFF]/40 transition-all duration-300"
