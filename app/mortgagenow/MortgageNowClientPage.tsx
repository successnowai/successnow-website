      ...
      <section className="relative text-center py-16 px-6 md:px-10 bg-black/20 backdrop-blur-sm">
        ...
        <div className="relative z-10 max-w-6xl mx-auto space-y-8">
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight">
            ...
            <span className="block text-white animate-fadeTextUp animation-delay-600">MortgageNOW fixes that.</span>
          </h2>

          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto animate-fadeTextUp animation-delay-900">
            Run a tighter, faster, more accountable mortgage business without chasing clients or burning yourself out.
            Our <strong className="text-white">AI handles 80% of your client process</strong> - follow-up, reactivation,
            consultation scheduling, and more.
          </p>
        </div>
      </section>
        ...
        <div className="mb-12">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              "Loan officers too busy to nurture potential clients properly",
              "Clients shopping elsewhere while you're handling other applications",
              "No-shows and missed consultations killing your conversion rates",
              "Manual processes eating up time that should be spent on loans",
        ...
        <div className="mb-12">
          ...
          <div className="grid gap-4 sm:grid-cols-1">
            {[
              ...
              "🎯 Reactivates cold leads automatically until they're ready to apply",
              "💬 Handles loan questions & FAQs instantly - no waiting for loan officers",
              "📈 Integrates seamlessly with your existing loan management system",
