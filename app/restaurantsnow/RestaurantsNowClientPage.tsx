...
export default function RestaurantsNowClientPage() {
  return (
    <IndustryPageTemplate
      ...
      heroSubtitle={
        <>
          AI that <span className="text-[#00BFFF]">Takes Reservations 24/7</span>
          <br />
          To Pack Your House
        </>
      }
      ...
      heroDescription={
        <>
          ...
          <span className="text-[#00BFFF]">AI takes reservations, manages waitlists, and promotes specials</span> to
          keep your restaurant buzzing.
        </>
      }
      ...
      finalCtaDescription="Join the most successful restaurants using AI to streamline operations and keep their tables full."
    />
  )
}
