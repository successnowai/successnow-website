    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-emerald-900 to-teal-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="text-center lg:text-left space-y-8">
              <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-emerald-500/20 to-teal-500/20 rounded-full border border-emerald-500/30">
                <Sparkles className="w-4 h-4 mr-2 text-yellow-400" />
                <span className="text-sm font-semibold text-emerald-300">EXCLUSIVE SAM DIXXON PARTNERSHIP</span>
              </div>
              ...
              <div className="p-8 text-center">
                <div className="flex flex-col items-center space-y-6">
                  ...
                  >
                    ...
                    <div className="w-32 h-32 rounded-full bg-gradient-to-br from-emerald-400/30 to-teal-600/50 backdrop-blur-sm border border-emerald-400/40 flex items-center justify-center relative overflow-hidden shadow-2xl">
                      {/* Inner glow layers */}
                      ...
                      <div
                        className="absolute inset-3 rounded-full bg-gradient-to-br from-emerald-400/50 to-teal-400/70 blur-xs animate-pulse"
                        style={{ animationDelay: "0.5s" }}
                      ></div>
                      <div
                        className="absolute inset-6 rounded-full bg-gradient-to-br from-emerald-300/60 to-teal-300/80 blur-sm animate-pulse"
                    ...
                    {/* Outer glow effects */}
                    <div className="absolute inset-0 w-32 h-32 rounded-full bg-emerald-400/30 blur-xl animate-pulse"></div>
                    <div
                      className="absolute inset-0 w-32 h-32 rounded-full bg-teal-400/20 blur-2xl animate-pulse"
                      style={{ animationDelay: "1.5s" }}
                    ></div>
                    <div
                      className="absolute -inset-4 w-40 h-40 rounded-full bg-emerald-300/10 blur-3xl animate-pulse"
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-2xl">
              <div className="p-8">
                <h3 className="text-2xl font-bold text-emerald-400 mb-6">🎯 The Sam Dixxon Advantage</h3>
                <div className="space-y-6">
                  <div>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-2xl">
              <div className="p-8">
                ...
                <p className="text-emerald-400 font-semibold mt-4 text-lg">- David K., Business Owner</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                { number: "1000+", label: "Success Stories", color: "text-emerald-400" },
                { number: "300%", label: "Average Growth", color: "text-green-400" },
                { number: "24/7", label: "AI Support", color: "text-yellow-400" },
                { number: "95%", label: "Client Satisfaction", color: "text-teal-400" },
              ].map((stat, index) => (
                <div
                  key={index}
            ...
            <div className="bg-white/10 backdrop-blur-md border border-orange-400/30 rounded-2xl shadow-2xl">
              <div className="p-8">
                <h3 className="text-2xl font-bold text-orange-400 mb-4 flex items-center">
                  ...
                  Exclusive Sam Dixxon Network Access
                </h3>
                <p className="text-white/90 mb-6 text-lg leading-relaxed">
                  Sam has secured special access and pricing for his trusted network. This is a limited-time opportunity
                  to join an exclusive group of forward-thinking business owners.
                </p>
        ...
        <div className="mt-16 text-center">
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-2xl">
            <div className="p-10">
              <h3 className="text-4xl font-bold text-emerald-400 mb-6 text-center">
                ✨ Join Sam's Exclusive Network Today
              </h3>
