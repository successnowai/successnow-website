      ...
      {isVisible && (
        ...
        >
          <motion.div
            ...
            className="relative max-w-2xl w-full bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl border border-orange-500/30 shadow-2xl overflow-hidden"
            ...
            <div className="relative p-8">
              ...
              <div className="space-y-6">
                <p className="text-gray-300 text-center leading-relaxed">
                  ...
                  <strong className="text-orange-400">$250,000 in pilot funding</strong> to help local businesses adopt
                  AI at an affordable price.
                </p>
