    ...
    <section className="relative min-h-screen flex items-center justify-center px-4 py-20 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto">
        ...
        <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
          Let our AI Superagents and AI bots close leads, book appointments, and reply to client inquiries—24/7. <span className="text-white font-semibold">Never lose a lead again.</span>
        </p>
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 max-w-4xl mx-auto shadow-2xl">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-4">
            The SUCCESSNOW Platform Project - Usually <span className="line-through text-gray-500">$35,000</span>, Now Just
          </p>
